...
<div id="comments" class="comments-area">
	...
	$args = array(
		...
		'url' => '<p class="comment-form-url field">' . '<i class="icon-link"></i><input id="url" name="url" type="text" value="' . esc_attr( $commenter['comment_author_url'] ) . '" size="30" />' . '<label for="url">' . __( 'Website', 'domainreference' ) . '</label> </p> </div>' ) )
	);
