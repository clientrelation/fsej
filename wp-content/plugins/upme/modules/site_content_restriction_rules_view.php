<!-- <tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Select whether you want to restrict entire site or part of the site for users based on following conditions.', 'upme') ?>"></i>
    </td>
</tr> -->
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Select type of content to be restricted.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Select posts to be restricted.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Select what type of users have access to restricted content.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td class='site_content_allowed_roles'>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Select which user roles will be allowed to access this content.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Specify the redirection URL for users with unauthorized access based on this rule.', 'upme') ?>"></i>
    </td>
</tr>
