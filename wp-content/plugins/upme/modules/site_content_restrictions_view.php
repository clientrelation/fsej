...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('Enable/ Disable site restriction rules defined in Content Restriction Rules section.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('These pages will be acessible to any user regardless of the restriction rule settings.', 'upme') ?>"></i>
    </td>
</tr>
...
<tr valign="top">
    ...
    <td>
        ...
        ?><i class="upme-icon-question-sign upme-tooltip2 option-help" original-title="<?php _e('These posts will be acessible to any user regardless of the restriction rule settings.', 'upme') ?>"></i>
    </td>
</tr>
